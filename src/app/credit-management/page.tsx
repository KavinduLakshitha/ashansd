...
//   isOpen: boolean;
//   type: 'realize' | 'bounce' | 'settle' | null;
      ...
      <Card>
        ...
        <Tabs defaultValue="cheques" className="mt-4 ml-4">
          <TabsList>
            ...
            <TabsTrigger value="realized-cheques">
              Realized Cheques ({pendingPayments.realizedCheques?.length || 0})
            </TabsTrigger>
            <TabsTrigger value="settled-credits">
              Settled Credits ({pendingPayments.settledCredits?.length || 0})
            </TabsTrigger>
          </TabsList>
